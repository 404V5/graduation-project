...
<html>
  ...
  <body style="margin: 5px;">
  	<table id="dg" title="药品信息" class="easyui-datagrid" fitColumns="true" 
  		pagination="true" rownumbers="true" url="<%=basePath%>/server/goods.action" fit="true" toolbar="#tb">
  			<thead>
  				<tr>
					...
					<th field="goodsname" width="20" align="center">药品名</th>
					<th field="supplierId" width="20" align="center" hidden="true">供应商ID</th>
					<th field="typeId" width="20" align="center" hidden="true">药品类型ID</th>
					<th field="supplier" width="20" align="center">供应商</th>
					<th field="type" width="20" align="center">药品类型</th>
	...
	<div id="tb">
		...
		<div>
			&nbsp;供应商：&nbsp;<input class="easyui-combobox" name="goods.s_supplier" id="s_supplier"
									data-options="panelHeight:'auto',editable:false,valueField:'value',textField:'value',url:'<%=basePath%>/server/dictionary!dictionaryComboList?name=供应商'"/>
			&nbsp;药品类型：&nbsp;<input class="easyui-combobox" name="goods.s_type" id="s_type"
									data-options="panelHeight:'auto',editable:false,valueField:'value',textField:'value',url:'<%=basePath%>/server/dictionary!dictionaryComboList?name=药品类型'"/>	
			&nbsp;药品名：&nbsp;<input type="text" name="goods.s_goodsname" id="s_goodsname"/>
				...
				<tr>
					...
					<td>
						...
						<input class="easyui-combobox" id="supplierId" name="goods.supplierId"
							data-options="panelHeight:'auto',editable:false,valueField:'id',textField:'value',url:'<%=basePath%>/server/dictionary!dictionaryComboList?name=供应商'"/>
					</td>
				</tr>
				<tr>
					<td>药品类型：</td>
					<td>
						...
						<input class="easyui-combobox" name="goods.typeId" id="typeId"
							data-options="panelHeight:'auto',editable:false,valueField:'id',textField:'value',url:'<%=basePath%>/server/dictionary!dictionaryComboList?name=药品类型'"/>
					</td>
				</tr>
			</table>
		</form>
