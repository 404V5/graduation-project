...
import hjj.jxc.model.Chuhuo;
import hjj.jxc.model.Kucun;
import hjj.jxc.model.PageBean;
import hjj.jxc.service.ChuhuoService;
import hjj.jxc.service.KucunService;
import hjj.jxc.util.DBUtil;
import hjj.jxc.util.JsonUtil;
import hjj.jxc.util.ResponseUtil;
import hjj.jxc.util.StringUtil;
