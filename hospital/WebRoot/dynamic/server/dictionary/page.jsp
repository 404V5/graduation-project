...
<html>
  ...
  <body style="margin: 5px;">
  	<table id="dg" title="数据字典信息" class="easyui-datagrid" fitColumns="true" 
  		pagination="true" rownumbers="true" url="<%=basePath%>/server/dictionary.action" fit="true" toolbar="#tb">
  			<thead>
  				<tr>
					...
					<th field="name" width="20" align="center">数据字典名称</th>
					<th field="value" width="20" align="center">数据字典值</th>
	...
	<div id="tb">
		...
		<div>
			&nbsp;数据字典名称 ：&nbsp;<select class="easyui-combobox" id="s_name" name="s_name" editable="false" panelHeight="auto">
		    	<option value="">请选择...</option>
				<option value="供应商">供应商</option>
				<option value="药品类型">药品类型</option>
				</select>			
			&nbsp;数据字典值：&nbsp;<input type="text" name="s_value" id="s_value"/>
