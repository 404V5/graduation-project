...
<body class="easyui-layout">
	<div region="north" style="height: 80px;background-color: #E0EDFF">
		...
		<div style="padding-top: 50px;padding-right: 20px;">当前用户：&nbsp;<font color="red" >${currentuser.username }</font>
			&nbsp;&nbsp;<a href="#" onclick="logout();return false;">注销</a></div>
		
	</div>
	<div region="center">
		<div class="easyui-tabs" fit="true" border="false" id="tabs">
			<div title="首页" >
				<div align="center" style="padding-top: 100px;"><font color="red" size="10">欢迎使用医院管理系统</font></div>
			</div>
		</div>
	</div>
	...
	<div region="south" style="height: 25px;" align="center">版权所有<a href="http://www.handson.com" target="_blank">www.handson.com</a></div>
</body>
</html>