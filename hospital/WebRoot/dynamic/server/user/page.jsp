...
<body style="margin: 5px;">
	 ...
	 pagination="true" rownumbers="true" url="<%=basePath%>/server/user.action" fit="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="username" width="100" align="center">会员名</th>
	...
	<div id="tb">
		...
		<div>&nbsp;会员名：&nbsp;<input type="text" name="s_username" id="s_username"/><a href="javascript:searchUser()" class="easyui-linkbutton" iconCls="icon-search" plain="true">搜索</a></div>
	</div>
