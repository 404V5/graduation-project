	...
	<body leftmargin="2" topmargin="9" background='<%=path %>/images/allbg.gif'>
			<form action="<%=path %>/timu_danxuan_Add.action" name="formAdd" method="post">
				     <table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
						<tr bgcolor="#EEF4EA">
					        <td colspan="3" background="<%=path %>/images/wbg.gif" class='title'><span>单选题</span></td>
					    </tr>
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    ...
						    <td width="75%" bgcolor="#FFFFFF" align="left">
						         <input type="text" name="timuName" size="20"/>
						    </td>
						</tr>
						<tr align='center' bgcolor="#FFFFFF" id="timuXuanxianga" height="22">
						    ...
						    <td width="75%" bgcolor="#FFFFFF" align="left">
						         <input type="text" name="timuXuanxianga" size="20"/>
						    </td>
						</tr>
						<tr align='center' bgcolor="#FFFFFF" id="timuXuanxiangb" height="22">
						    ...
						    <td width="75%" bgcolor="#FFFFFF" align="left">
						         <input type="text" name="timuXuanxiangb" size="20"/>
						    </td>
						</tr>
						<tr align='center' bgcolor="#FFFFFF" id="timuXuanxiangc" height="22">
						    ...
						    <td width="75%" bgcolor="#FFFFFF" align="left">
						         <input type="text" name="timuXuanxiangc" size="20"/>
						    </td>
						</tr>
						<tr align='center' bgcolor="#FFFFFF" id="timuXuanxiangd" height="22">
						    ...
						    <td width="75%" bgcolor="#FFFFFF" align="left">
						         <input type="text" name="timuXuanxiangd" size="20"/>
						    </td>
						</tr>
						<tr align='center' bgcolor="#FFFFFF" height="22" id="radioo">
						    ...
						    <td width="75%" bgcolor="#FFFFFF" align="left">
						        <input type="text" name="timuDaan" size="20"/>
