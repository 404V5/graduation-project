...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
           ...
           var s=0;
           function timuAddShiti(timuId,shitiId)
           {
               s=timuId;
               document.getElementById("indicator"+s).style.display="block";
               loginService.timuAddShiti(timuId,shitiId,callback);
           }
	...
	<body>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
						<a style="color: red" href="#" onclick="timuAddShiti(<s:property value="#timu.timuId"/>,<s:property value="#request.shitiId"/>)" class="pn-loperator">添加</a>
