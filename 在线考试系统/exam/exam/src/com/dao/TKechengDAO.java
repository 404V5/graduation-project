...
public class TKechengDAO extends HibernateDaoSupport
{
	...
	// property constants
	public static final String KECHENG_BIANHAO = "kechengBianhao";

	public static final String KECHENG_NAME = "kechengName";

	public static final String KECHENG_XUESHI = "kechengXueshi";
	...
	public List findByKechengBianhao(Object kechengBianhao)
	{
		return findByProperty(KECHENG_BIANHAO, kechengBianhao);
	}

	public List findByKechengName(Object kechengName)
	{
		return findByProperty(KECHENG_NAME, kechengName);
	}

	public List findByKechengXueshi(Object kechengXueshi)
	{
		return findByProperty(KECHENG_XUESHI, kechengXueshi);
	}
