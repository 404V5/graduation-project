 ...
 <jsp:include page="../upTwo.jsp"/>
  ...
  <tr>
	...
	<table width="99%" height="16"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td bgcolor="#E6E6E6"><div align="center"><font color="#990000"><b>连接网站信息的查询</b></font></div></td>
      </tr>
    </table>
<br><br>
      ...
      LinkForm form=(LinkForm)list.get(i);
        ...
        <tr>
          ...
          <td><div align="center"><a href="<%=form.getLinkPicture()%>" target="_blank">查看图片</a>&nbsp;&nbsp;<a href="javascript:deleteAffiche('<%=form.getId()%>')">删除</a></div></td>
      <%}%>  </tr>
      </table>
	  <br>
