...
<div id="content">
  <div id="left">
    ...
    <div class="left_title">
        ...
        style="CURSOR:pointer;font-family: 微软雅黑;">修改我的信息</a>
    </div>
    <ul id="submenu_1" class="dis">
      <li class="left_link"><a href="<%=path %>/auser/userinfo/userinfo.jsp" target="mainFrame" style="font-family: 微软雅黑;">修改我的信息</a></li>
    </ul>
    <!-- 111 -->
    ...
    <div class="left_title">
        ...
        style="CURSOR:pointer;font-family: 微软雅黑;">我的房屋出租</a>
    </div>
    <ul id="submenu_2" class="dis">
      <li class="left_link"><a href="<%=path %>/chuzu?type=chuzuMine" target="mainFrame" style="font-family: 微软雅黑;">我的房屋出租</a></li>
      <li class="left_link"><a href="<%=path %>/auser/chuzu/chuzuAdd.jsp" target="mainFrame" style="font-family: 微软雅黑;">发布房屋出租</a></li>
    </ul>
  </div>
</div>
</body>
