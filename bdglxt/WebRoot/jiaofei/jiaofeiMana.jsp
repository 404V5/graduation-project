...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/img/allbg.gif'>
			...
			<c:if test="${sessionScope.userinfo.quanxian!=0}" >
			<table width='98%'  border='0'style="margin-top:8px;margin-left: 5px;">
			  <tr>
			    <td>
			    	<form action="<%=path %>/jfxx?type=jfglAdd" method="post">
			    	缴费金额：<input type="text" name="jine" id="jine"/>&nbsp;
			    	缴费方式：
						<select name="jffs">
			    	...
			    	<input type="hidden" name="bdid" value="${requestScope.bdid}"/>
			      	<input type="submit" value="保存" style="width: 80px;" onclick="return subVal()"/>
			      </form>
			    </td>
			  </tr>
		    </table>
