	...
	<body leftmargin="2" topmargin="9" background='<%=path %>/img/allbg.gif'>
			...
			<form action="<%=path %>/lpgl?type=lpglAdd" name="formAdd" method="post">
			     <table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
					<tr bgcolor="#EEF4EA">
				        <td colspan="3" background="<%=path %>/img/wbg.gif" class='title'><span>理赔信息添加</span></td>
				    </tr>
					...
					<tr align='center' bgcolor="#FFFFFF" height="22">
						...
						<td width="75%" bgcolor="#FFFFFF" align="left">
							<textarea rows="8" cols="19" name="chuli"></textarea>
						</td>
					</tr>
					<tr align='center' bgcolor="#FFFFFF" height="22">
						<td width="25%" bgcolor="#FFFFFF" align="right">
					...
					<tr align='center' bgcolor="#FFFFFF" height="22">
					    ...
					    <td width="75%" bgcolor="#FFFFFF" align="left">
					    	<input type="hidden" name="baid" value="${requestScope.baxx.id}"/>
